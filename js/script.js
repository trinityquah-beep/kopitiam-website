...
const navLinks = document.querySelectorAll('.nav-menu a');window.addEventListener('scroll', () => {
    let current = '';
...
if (reservationForm) {
    console.log('Adding submit event listener to reservation form');reservationForm.addEventListener('submit', async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            // Send as JSON (which is what Google Apps Script typically expects)
